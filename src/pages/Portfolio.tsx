  ...
  <PageTransition>
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="px-6 md:px-12 lg:px-20 py-20 max-w-3xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-light tracking-wide mb-8" style={{ fontFamily: "var(--font-display)" }}>Portfolio</h1>
        <p className="text-foreground/60 text-lg leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
          A curated collection of ventures we've backed — from fintech to climate tech — driving measurable impact across the Global South.
        </p>
      </main>
    </div>
  </PageTransition>
